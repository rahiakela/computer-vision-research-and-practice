...
- **[License_plate_detection_YOLOv4.ipynb](https://github.com/rahiakela/computer-vision-research-and-practice/blob/main/alpr-project/01_license_plate_detection_YOLOv4.ipynb)**: This notebook contains end to end implementation of license plate detection using YOLOv4. It includes code for training, evaluation and inference based on darknet.
